...
main(int argc, char *argv[])
{
  ...
  1e:	87e58593          	addi	a1,a1,-1922 # 898 <malloc+0x102>
  22:	4509                	li	a0,2
  24:	00000097          	auipc	ra,0x0
  28:	68c080e7          	jalr	1676(ra) # 6b0 <fprintf>
        exit(1);
  2c:	4505                	li	a0,1
  ...
  3a:	84a58593          	addi	a1,a1,-1974 # 880 <malloc+0xea>
  3e:	4509                	li	a0,2
  40:	00000097          	auipc	ra,0x0
  44:	670080e7          	jalr	1648(ra) # 6b0 <fprintf>
        exit(1);
  48:	4505                	li	a0,1
  ...
  56:	35c080e7          	jalr	860(ra) # 3ae <sleep>
    exit(0);
  5a:	4501                	li	a0,0
...
dev:
 li a7, SYS_dev
 3c8:	6889                	lui	a7,0x2
 3ca:	7668889b          	addiw	a7,a7,1894 # 2766 <__global_pointer$+0x161d>
 ecall
 3ce:	00000073          	ecall
 ret
 3d2:	8082                	ret
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 450:	4ec50513          	addi	a0,a0,1260 # 938 <digits>
 454:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 50c:	3d8c8c93          	addi	s9,s9,984 # 8e0 <malloc+0x14a>
 ...
 51a:	422b8b93          	addi	s7,s7,1058 # 938 <digits>
 ...
 640:	29c98993          	addi	s3,s3,668 # 8d8 <malloc+0x142>
        while(*s != 0){
 644:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 722:	2327b783          	ld	a5,562(a5) # 950 <freep>
 ...
 74a:	00e6ea63          	bltu	a3,a4,75e <free+0x4a>
{
 ...
 78c:	1cf73423          	sd	a5,456(a4) # 950 <freep>
}
 790:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7be:	19653503          	ld	a0,406(a0) # 950 <freep>
 ...
 7e6:	16e90913          	addi	s2,s2,366 # 950 <freep>
  if(p == (char*)-1)
 7ea:	5afd                	li	s5,-1
 7ec:	a8a5                	j	864 <malloc+0xce>
    base.s.ptr = freep = prevp = &base;
 7ee:	00000797          	auipc	a5,0x0
 7f2:	16278793          	addi	a5,a5,354 # 950 <freep>
 7f6:	00000717          	auipc	a4,0x0
 7fa:	16270713          	addi	a4,a4,354 # 958 <base>
 7fe:	e398                	sd	a4,0(a5)
 800:	e798                	sd	a4,8(a5)
    base.s.size = 0;
 ...
 826:	12a73723          	sd	a0,302(a4) # 950 <freep>
      return (void*)(p + 1);
